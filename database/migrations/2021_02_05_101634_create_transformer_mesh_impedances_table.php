...
class CreateTransformerMeshImpedancesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('transformer_mesh_impedances', function (Blueprint $table) {
            $table->id();
            $table->timestamps();
            $table->softDeletes();
    ...
    {
        Schema::dropIfExists('transformer_mesh_impedances');
    }
}
