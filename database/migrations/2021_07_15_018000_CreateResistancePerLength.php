...
class CreateResistancePerLength extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('resistance_per_length', function (Blueprint $table) {
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('resistance_per_length');
