...
<form class="form-horizontal" name="form_substationtpinfo" action="{{ route('substationtpinfo.update', ['id'=>$content->id]) }}" method="POST" enctype="multipart/form-data">
    {!! method_field('POST') !!}
    {{ @csrf_field() }}
    ...
    <div class="page-header">
        {{-- заголовок --}}
        <h2 class="page-title">
            {{ App\Models\Substationtpinfo::title1 }}
        </h2>

        {{-- хлебные крошки --}}
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('admin') }}">Главная</a></li>
            <li class="breadcrumb-item"><a href="{{ route('substationtpinfo.index') }}">{{ App\Models\Substationtpinfo::title2 }}</a></li>
                            ...
                            <div class="nav-tabs-horizontal" data-plugin="tabs">
                                ...
                                <div class="tab-content pt-20">
                                    ...
                                    <div class="tab-pane active" id="tabsMain" role="tabpanel">
                                        ...
                                        'myFieldTitle' => 'Подскласс (subclass)',
