...
@section("title")
    {{ App\Models\Dischargerinfo::title2 }}
@endsection
    ...
    @if (
        ...
        <div class="page-header">
            ...
            <div class="page-header-actions">
                @if (
                    ...
                    <a href="{{ route('dischargerinfo.edit') }}" class="button" data-toggle="tooltip" data-original-title="Создать новую запись">
        ...
        <div class="row row-lg">
            <div class="col-lg-12">
                ...
                <model-spisok-dischargerinfo-component title-one="{{ App\Models\Dischargerinfo::title1 }}" get-user-role='{{ Auth::user()->role[0]->name }}'>
                </model-spisok-dischargerinfo-component>
            </div>
        </div>
    </div>
    @else
