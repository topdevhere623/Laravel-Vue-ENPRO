...
{{-- проверка прав доступа к странице --}}
    ...
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{ App\Models\OverheadWireInfo::title2 }}</li>
        </ol>
        
         <div class="page-header-actions">
        <a
        
          href="{{ route('overhead_wire_info.edit') }}"
          class="button"
          data-toggle="tooltip"
        ...
        <div class="page-content">
                <div class="row row-lg">
                    <div class="col-lg-12">
                        {{-- содержимое таблицы списком - vue-компонент --}}
                        <model-spisok-wireinfo-component title-one="{{ App\Models\OverheadWireInfo::title2 }}" get-model-name="OverheadWireInfo" get-user-role='{{ Auth::user()->role[0]->name }}'>
