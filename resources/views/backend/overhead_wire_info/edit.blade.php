...
@section("content")
    ...
    @if (
        ...
        {{-- карточка линии --}}
        <model-edit-wireinfo-component :get-kind-models='@json($kindModels)' get-model-name="OverheadWireInfo" title-one="{{ App\Models\OverheadWireInfo::title2 }}" :get-model-id='{{ isset($id) ? $id : 0 }}' :from-id="{{ isset($fromId) ? $fromId : 0 }}">
