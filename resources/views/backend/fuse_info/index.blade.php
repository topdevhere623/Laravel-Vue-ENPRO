...
{{-- проверка прав доступа к странице --}}
    ...
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Предохранители 3 кВ и выше (ГОСТ 2213)</li>
        </ol>
        
         <div class="page-header-actions">
        <a
        
          href="{{ route('fuse_info.edit') }}"
          class="button"
          data-toggle="tooltip"
        ...
        <div class="page-content">
                <div class="row row-lg">
                    <div class="col-lg-12">
                        <model-spisok-fuse-info-component get-user-role='{{ Auth::user()->role[0]->name }}'>
                        </model-spisok-fuse-info-component>
                    </div>
                </div>
            </div>
        </div>
