    ...
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                {{App\Models\OldTransformerTankInfo::title2}}
            </li>
        </ol>
        ...
        <a
          ...
          href="{{ route('old_transformer_tank_info.edit') }}"
          class="button"
          data-toggle="tooltip"
        ...
        <div class="page-content">
                <div class="row row-lg">
                    <div class="col-lg-12">
                        {{-- содержимое таблицы списком - vue-компонент --}}
                        <model-spisok-oldtransformertankinfo-component get-user-role='{{ Auth::user()->role[0]->name }}'>
                        </model-spisok-oldtransformertankinfo-component>
                    </div>
                </div>
            </div>
        </div>
