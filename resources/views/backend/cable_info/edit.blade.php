...
@section("content")
    ...
    @if (
        ...
        {{-- карточка линии --}}
        <model-edit-wireinfo-component get-model-name="CableInfo" :get-kind-models='@json($kindModels)' title-one="{{ App\Models\CableInfo::title2 }}" :get-model-id="{{ isset($id) ? $id : 0 }}" :from-id="{{ isset($fromId) ? $fromId : 0 }}">
