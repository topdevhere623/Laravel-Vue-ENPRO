...
@section("content")
    ...
    @if (
        ...
        {{-- карточка линии --}}
        <model-edit-enproclassdefect-component title-one="{{ App\Models\enproclassdefect::title2 }}" :get-model-id='{{ isset($id) ? $id : 0 }}'>
        </model-edit-enproclassdefect-component>
