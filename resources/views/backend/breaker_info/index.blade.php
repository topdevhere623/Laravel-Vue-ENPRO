...
{{-- проверка прав доступа к странице --}}
    ...
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">{{ App\Models\BreakerInfo::title2 }}</li>
        </ol>
        
         <div class="page-header-actions">
        <a
        
          href="{{ route('breaker_info.edit') }}"
          class="button"
          data-toggle="tooltip"
        ...
        <div class="page-content">
                <div class="row row-lg">
                    <div class="col-lg-12">
                        {{-- содержимое таблицы списком - vue-компонент --}}
                        <model-spisok-breaker-info-component title-one="{{ App\Models\BreakerInfo::title2 }}" get-model-name="BreakerInfo" get-user-role='{{ Auth::user()->role[0]->name }}'>
                        </model-spisok-breaker-info-component>
                    </div>
                </div>
            </div>
        </div>
