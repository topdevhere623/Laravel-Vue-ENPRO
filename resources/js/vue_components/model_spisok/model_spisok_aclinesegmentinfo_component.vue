                ...
                <tbody>
                    ...
                    <tr v-for="(item, index) in modelData.data" :key="index">
                        ...
                        <td class="text-center">
                            <a :href="`aclinesegmentinfo/edit/${item.id}`">
                                {{ item.id }}
                            </a>
                        </td>
                        <td class="text-center">
...
export default {
    ...
    data() {
        return {
            ...
            contentTh: {
                ...
                2: {
                    name: "Подкласс",
                    sortFieldName: "subclass",
                    width: "auto"
                },
                3: {
                    name: "Напряжение",
                    sortFieldName: "voltageid",
                    width: "auto"
                },
                4: {
                    name: "UNOM",
    ...
    methods: {
        ...
        funLoadContent(page = 1) {
            ...
            axios
                .post("/api/aclinesegmentinfoVueIndex", form)
                .then(response => {
                    // для отладки
        ...
        async funSelectedRows() {
            ...
            await axios
                .post("/api/aclinesegmentinfoVueDelete", form)
                .then(response => {
                    // запрос прошел
                    // для отладки
