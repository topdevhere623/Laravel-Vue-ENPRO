        ...
        <tbody>
          ...
          <tr v-for="(item, index) in modelData.data" :key="index">
            ...
            <td class="text-center">
              <a :href="`basevoltage/edit/${item.id}`">
                {{ item[1] }}
              </a>
            </td>
            <td class="text-center">
  ...
  data() {
    return {
      ...
      contentTh: {
        ...
        1: {
          name: "codeProfession",
          sortFieldName: "Код должности",
          width: "auto",
        },
        2: {
          name: "Номинал",
          sortFieldName: "Сокращенное наименование",
          width: "auto",
        },
        3: {
          name: "Статус",
          sortFieldName: "Полное наименование профессии",
          width: "auto",
        },
      },
      selectedAll: false,
  ...
  methods: {
    ...
    funLoadContent(page = 1) {
      ...
      const data = [
        [
          1,
          "19855-0-09-7411-2-0-20-1-3",
          "Электромонтер по ремонту вл 2р",
          "Электромонтер по ремонту воздушных линий электропередачи 2 разрядя",
        ],
        [
          2,
          "19855-0-09-7411-3-0-20-1-3",
          "Электромонтер по ремонту вл 3р",
          "Электромонтер по ремонту воздушных линий электропередачи 3 разрядя",
        ],
        [
          3,
          "19855-0-09-7411-4-0-20-1-3",
          "Электромонтер по ремонту вл 4р",
          "Электромонтер по ремонту воздушных линий электропередачи 4 разрядя",
        ],
        [
          4,
          "19855-0-09-7411-5-0-20-1-3",
          "Электромонтер по ремонту вл 5р",
          "Электромонтер по ремонту воздушных линий электропередачи 5 разрядя",
        ],
        [
          5,
          "19855-0-09-7411-6-0-20-1-3",
          "Электромонтер по ремонту вл 6р",
          "Электромонтер по ремонту воздушных линий электропередачи 6 разрядя",
        ],
        [
          6,
          "19855-0-09-7411-7-0-20-1-3",
          "Электромонтер по ремонту вл 7р",
          "Электромонтер по ремонту воздушных линий электропередачи 7 разрядя",
        ],
        [
          7,
          "19855-0-09-7411-8-0-20-1-3",
          "Электромонтер по ремонту вл 8р",
          "Электромонтер по ремонту воздушных линий электропередачи 8 разрядя",
        ],
        [
          8,
          "19855-0-09-7411-9-0-20-1-3",
          "Электромонтер по ремонту вл 9р",
          "Электромонтер по ремонту воздушных линий электропередачи 9 разрядя",
        ],
        [
          9,
          "19855-0-09-7411-10-0-20-1-3",
          "Электромонтер по ремонту вл 10р",
          "Электромонтер по ремонту воздушных линий электропередачи 10 разрядя",
        ],
      ];
      ...
      // axios
      //     .post("/api/basevoltageVueIndex", form)
      //     .then(response => {
      //         // для отладки
    ...
    async funSelectedRows() {
      ...
      // await axios
      //     .post("/api/basevoltageVueDelete", form)
      //     .then(response => {
      //         // запрос прошел
      //         // для отладки
    ...
    funSorting(getCol) {
      ...
      //     } else {
      //         this.sorting.direct =
      //             this.sorting.direct === "asc" ? "desc" : "asc";
      //     }
      //     // столбец
