      ...
      >
        ...
        <tr v-for="item in modelData.data" :key="item.id">
          ...
          <td class="text-center">
            <a :href="'/admin/towerconstructionaggregate/edit/' + item.id">
              {{ item.id }}
            </a>
          </td>
          <td>
          ...
          <td>
            <a
              ...
              :href="
                  '/public/uploads/models/towerconstructionaggregate/' +
                  item.id +
                  '/' +
                  item.img
                "
          ...
          <td class="text-center">
            {{ item.towerconstructionaggregates.length }}
          </td>
          <td class="text-center">
  ...
  export default {
    ...
    methods: {
      ...
      funLoadContent(page = 1) {
        ...
        axios
          .post("/api/towerconstructionaggregateVueIndex", form)
          .then((response) => {
            // для отладки
      ...
      async funSelectedRows(getRegim) {
        ...
        await axios
          .post("/api/towerconstructionaggregateVueSelectedRows", form)
          .then((response) => {
            // запрос прошел
            // для отладки
