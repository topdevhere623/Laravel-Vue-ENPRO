...
<!--        </li>-->
      ...
      <div class="page-header-actions">
        <a
          ...
          "
          href="/admin/enpro_group_defect/edit"
          class="button"
          data-toggle="tooltip"
              ...
              <tbody>
                <tr v-for="item in modelData.data" :key="item.id">
                  ...
                  <td class="text-center">
                    ...
                    <a :href="'/admin/enpro_group_defect/edit/?id=' + item.id">
                      {{ item.id }}
                    </a>
                  </td>
                  <td class="">
...
export default {
  ...
  data() {
    return {
      ...
      contentTh: {
        ...
        1: {
          name: "Код группы измерений",
          sortFieldName: "code_group",
          width: "auto",
        },
        2: {
      ...
      sorting: { col: "code_group", direct: "asc" },
    };
  },
  mounted() {
    // общая загрузка
  ...
  methods: {
    ...
    async funLoadContent(page = 1) {
      ...
      let url = "/api/enpro_group_defect?page=" + page;
    ...
    async funSelectedRows() {
      ...
      let url = "/api/enpro_group_defect/";
