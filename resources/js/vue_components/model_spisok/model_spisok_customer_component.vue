...
export default {
  ...
  data() {
    return {
      ...
      contentTh: {
        ...
        4: {
          name: "В пролетах",
          sortFieldName: "spanskol",
          width: 75,
        },
        5: {
          name: "В сегментах",
          sortFieldName: "segmentskol",
          width: 75,
        },
        6: {
          name: "В линиях",
          sortFieldName: "aclineskol",
          width: 75,
        },
        7: {
          name: "Линии",
          sortFieldName: "aclinesname",
          width: "auto",
        },
        8: {
          name: "Обновлено",
  ...
  methods: {
    ...
    funLoadContent(page = 1) {
      ...
      axios
        .post("/api/customerVueIndex", form)
        .then((response) => {
          // для отладки
    ...
    async funSelectedRows() {
      ...
      await axios
        .post("/api/customerVueDelete", form)
        .then((response) => {
          // запрос прошел
          // для отладки
