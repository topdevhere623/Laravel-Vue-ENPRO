    ...
    <div class="page-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
          ...
          <a :href="`/admin/disconnector_info`">{{ titleOne }}</a>
        </li>
      ...
      <div class="page-header-actions">
        ...
        <a href="/admin/disconnector_info" class="button"> Закрыть </a>
      </div>
    </div>
      ...
      modelData: {
        ...
        SwitchInfo: {
          ...
          ratedCurrent: {
            value: null,
            id: null,
            label: "Номинальный ток разъединителя",
          },
          ...
          enproBreakForce: {
            value: null,
            id: null,
            label: "Допустимое горизонтальное тяжение провода, Н",
          },
    ...
    async funLoad(getModelId) {
      ...
      await axios
        ...
        .then((response) => {
          ...
          this.modelData.OldSwitchInfo.DisconnectorInfo.id =
            DATA.OldSwitchInfo.DisconnectorInfo.id;
