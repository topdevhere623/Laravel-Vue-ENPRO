    ...
    <div class="page-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
          ...
          <a :href="`/admin/fuse_info`">{{ titleOne }}</a>
        </li>
      ...
      <div class="page-header-actions">
        ...
        <a href="/admin/fuse_info" class="button"> Закрыть </a>
      </div>
    </div>
      ...
      modelData: {
        ...
        SwitchInfo: {
          ...
          ratedCurrent: {
            value: null,
            id: null,
            label: "Номинальный ток предохранителя",
          },
          breakingCapacity: {
            value: null,
            id: null,
    ...
    async funLoad(getModelId) {
      ...
      await axios
        ...
        .then((response) => {
          ...
          console.log(1);
          this.modelData.OldSwitchInfo.FuseInfo.id =
            DATA.OldSwitchInfo.FuseInfo.id;
