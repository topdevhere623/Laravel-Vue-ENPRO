    ...
    <div class="page-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
          ...
          <a :href="`/admin/recloser_info`">{{ titleOne }}</a>
        </li>
      ...
      <div class="page-header-actions">
        ...
        <a href="/admin/recloser_info" class="button"> Закрыть </a>
      </div>
    </div>
      ...
      async funLoad(getModelId) {
        ...
        await axios
          ...
          .then((response) => {
            ...
            console.log(1);
            this.modelData.OldSwitchInfo.RecloserInfo.id =
              DATA.OldSwitchInfo.RecloserInfo.id;
