  ...
  <section>
    <div class="page-header">
      ...
      <ol class="breadcrumb">
        ...
        <!--                </li>-->
        <li class="breadcrumb-item">
          <a href="/admin/enpro_class_defect">{{ titleOne }}</a>
        </li>
      ...
      <div class="page-header-actions">
        <!-- кнопка выход -->
        <a href="/admin/enpro_class_defect" class="button">
          Закрыть
        </a>
      </div>
    </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <div class="form-field">
                            ...
                            <input type="text" class="text-field" name="type"
                                   v-model="modelData.type" placeholder="Код вида группы"/>
                          </div>
                          <!-- class -->
                          <div class="form-field">
                            <div class="form-input-label">
                            ...
                            <input type="text" class="text-field" name="class"
                          ...
                          <div class="form-field">
                            ...
                            <input type="text" class="text-field" name="title"
  ...
  export default {
    ...
    methods: {
      ...
      funLoad() {
        ...
        axios
          .get("/api/enpro_class_defect/" + this.getModelId)
          .then(response => {
            // запрос прошел
            // для отладки
      ...
      async funSave() {
        ...
        if (this.getModelId > 0) {
          await axios
            .put("/api/enpro_class_defect/" + this.getModelId, this.modelData)
            .then(response => {
          ...
          await axios
            .post("/api/enpro_class_defect", this.modelData)
            .then(response => {
