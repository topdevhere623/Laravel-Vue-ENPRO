        ...
        <div class="page-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                  {{
                    getModelId ? `Редактирование ${modelData.name && '- ' + modelData.name}` : `Создание - ${modelData.name && modelData.name !== '' ? modelData.name : 'Марки опор'}`
                  }}
                </li>
            </ol>
            ...
            <div class="page-header-actions">
                <!-- кнопка выход -->
                <a href="/admin/towerinfo" class="button">
                    Выход
                </a>
            </div>
                            ...
                            <div class="example-wrap">
                                <div class="nav-tabs-horizontal" data-plugin="tabs">
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" data-toggle="tab" href="#tabComponents" aria-controls="tabComponents" role="tab" aria-selected="true">
                                                Компоненты
                                            </a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" data-toggle="tab" href="#tabComponentsItogo" aria-controls="tabComponentsItogo" role="tab" aria-selected="true">
                                                Спецификация
                                            </a>
                                        </li>
                                    ...
                                    <div class="tab-content pt-20">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-field">
                                                        ...
                                                        <input type="text" class="text-field" name='series' v-model="modelData.series" placeholder="серия, ГОСТ, ТУ">
                                                    </div>

                                                    <!-- обозначение (альбом) -->
                                                    <div class="form-field">
                                                        <div class="form-input-label">Обозначение</div>
                                                        <input type="text" class="text-field" name='series' v-model="modelData.album" placeholder="обозначение">
                                                    </div>

                                                    <!-- наименование -->
                                                    <div class="form-field">
                                                        <div class="form-input-label">Наименование</div>
                                                        <input type="text" class="text-field" name='name' v-model="modelData.name" placeholder="наименование">
                                                    </div>

                                                    <!-- марка -->
                                                    <div class="form-field">
                                                        <div class="form-input-label">Марка</div>
                                                        <input type="text" class="text-field" name='mark' v-model="modelData.mark" placeholder="марка">
                                                    </div>

                                                    <!-- материал опоры -->
                                                    <options-sprav-component get-sprav='Towermaterial' get-title='Материал опоры' get-field='towermaterial_id' :get-current-id="modelData.towermaterial_id" @spravSelect="funUpdateSpravTowermaterial">
                                                    </options-sprav-component>

                                                    <!-- назначение опоры-->
                                                    <options-sprav-component get-sprav='Towerkind' get-title='Назначение опоры' get-field='towerkind_id' :get-current-id="modelData.towerkind_id" @spravSelect="funUpdateSpravTowerkind">
                                                    </options-sprav-component>

                                                    <!-- кол-во проводов -->
                                                    <div class="form-field">
                                                        <div class="form-input-label">Кол-во проводов</div>
                                                        <input type="number" class="text-field" v-model="modelData.wiren" placeholder="кол-во проводов">
                                                    </div>

                                                    <!-- редактирование подкоса -->
                                                    <div class="checkbox mt-15">
                                                        <label>
                                                            <input type="checkbox" v-model="modelData.strut">
                                                            <span class="box"></span>
                                                            <span>Подкос</span>
                                                        </label>
                                                    </div>
                                                                    ...
                                                                    <div class="form-group col text-center">
                                                                        ...
                                                                        <div>
                                                                            <a v-if="modelData.img !== '' && modelData.img != null"
                                                                               class='image'
                                                                               :href="('/public/uploads/models/towerinfo/' + getModelId + '/' + modelData.img)"
                                                                               target="_blank">

                                                                                <img :src="('/public/uploads/models/towerinfo/' + getModelId + '/' + modelData.img)"
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                <div class="row">
                                                                    <div class="form-group col text-center">
                                                                        ...
                                                                        <div style="display: inline-flex;">
                                                                            <h4 class="example-title">Чертеж</h4>
                                                                            <button type="button" class="link-icon"
                                                                                    @click="funSelectImg('img_draft')">
                                                                                <span class="wb-download"></span>
                                                                            </button>
                                                                            <button type="button" class="link-icon"
                                                                                    @click="funDeleteImg('img_draft')">
                                                                                <span class="wb-close-mini"></span>
                                                                            </button>
                                                                        </div>
                                                                        <div>
                                                                            <a v-if="modelData.img_draft !== '' && modelData.img_draft != null"
                                                                               :href="('/public/uploads/models/towerinfo/' + getModelId + '/' + modelData.img_draft)"
                                                                               target="_blank">

                                                                                <img :src="('/public/uploads/models/towerinfo/' + getModelId + '/' + modelData.img_draft)"
                                                                                     style="max-width:300px; max-height:200px;">
                                                                            </a>
                                                                            <img v-else :src="('/public/uploads/default/default_hd.png')"
                                                                                 style="max-width:300px; max-height:200px;">
                                        ...
                                        <div class="tab-pane" id="tabComponents" role="tabpanel">
                                            ...
                                            <tower-construction-master-pivots-component get-model-name="Towerinfo" :get-model-id="getModelId" @updatePivots="funUpdateConstructionPivots">
                                        ...
                                        <div class="tab-pane" id="tabComponentsItogo" role="tabpanel">
                                            ...
                                            <tower-construction-master-itogo-component get-model-name="Towerinfo" :get-model-id="getModelId" :get-last-update="lastUpdateDateTime">
    ...
    export default {
        ...
        methods: {
            ...
            async funSave() {
                ...
                await axios
                    .post('/api/towerinfoVueSave', form)
                    .then(
                        response => {
                            // запрос прошел
            ...
            async funUploadImg() {
                ...
                await axios
                    ...
                    .then(response => {
                        ...
                        newFullName = newFullName.replace('uploads/models/towerinfo/' + this.getModelId + '/', '');
            ...
            async funDeleteImg(getImgField) {
                ...
                // данные post-запроса
                let form = new FormData();
                form.append('getFile', 'towerinfo\\' + this.getModelId + '\\' + this.modelData[getImgField]);
