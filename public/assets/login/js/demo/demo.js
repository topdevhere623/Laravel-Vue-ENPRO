    ...
    var runDemoSourceCode = function () {
        ...
        if (bsElement.length) {
            ...
            $("<link/>", {
                rel: "stylesheet",
                type: "text/css",
                href: window.location.protocol + '//' + window.location.hostname + '/public/assets/login/js/plugins/highlight/styles/github.css'
            }).appendTo("head");

            $.getScript(window.location.protocol + '//' + window.location.hostname + '/public/assets/login/js/plugins/highlight/highlight.pack.js');
    ...
    var runDemoSettings = function () {
        ...
        if ($('#customizer').length) {
            ...
            $('#header-option').on('click', function () {
                ...
                // Save new admin_setting to Settings Key
