$(document).ready(function () {
    $(document).snowfall({image: "/public/assets/common/libs/snow/images/snow3.png", minSize: 10, maxSize: 20});
});
...
Date.now || (Date.now = function () {
    ...
    t.snowfall = function (e, i) {
        ...
        var a = [], o = {flakeCount: 35, flakeColor: "#b4d0ff", flakePosition: "absolute", flakeIndex: 999999, minSize: 1, maxSize: 2, minSpeed: 1, maxSpeed: 2, round: !1, shadow: !1, collection: !1, collectionHeight: 40, deviceorientation: !1},
        ...
        i.round && t(".snowfall-flakes").css({"-moz-border-radius": i.maxSize, "-webkit-border-radius": i.maxSize, "border-radius": i.maxSize}), i.shadow && t(".snowfall-flakes").css({
