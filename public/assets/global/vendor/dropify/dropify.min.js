...
!function (e, i) {
    ...
    function i(i, t) {
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            var s = {
                ...
                messages: {"default": "Перетащите изображение сюда или кликните для обзора", replace: "Чтобы обновить изображением, перетащите сюда новое изображение или кликните для обзора", remove: "Очистить", error: "Ooops, something wrong appended."},
                error: {
    ...
    return i.prototype.onChange = function () {
        ...
        this.file.object = e, this.file.name = e.name, this.file.size = e.size, this.file.type = e.type, this.file.width = null, this.file.height = null, $('#img-current').val(e.name)
        ...
        this.file.object = null, this.file.name = null, this.file.size = null, this.file.type = null, this.file.width = null, this.file.height = null, $('#img-current').val('')
    },
