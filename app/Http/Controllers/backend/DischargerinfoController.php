...
// контроллер модели
class DischargerinfoController extends Controller
{
    ...
    public function index()
    {
        ...
        // $content = Dischargerinfo::paginate($paginate);

        // открыть вюшку
        return view('backend.dischargerinfo.index');
    }
    ...
    public function vueIndex(Request $request)
    {
        ...
        $myReturn = Dischargerinfo::when(isset($getFilterName), function ($query) use ($getFilterName) {
    ...
    public function edit($id = null)
    {
        // контент
        if ($id) {
            $content = Dischargerinfo::findOrFail($id);
        } else {
            $content = new Dischargerinfo;
        }

        // открыть вьюшку
        return view('backend.dischargerinfo.edit', compact('content'));
    }

    // сохранение данных
    public function update($id = null, Request $request)
    {
        $bool = $this->commonCrudService->store('Dischargerinfo', $id, $request);
        // редирект
        return redirect(route('dischargerinfo.index'));
    }
    ...
    public function destroy($id)
    {
        ...
        $bool = $this->commonCrudService->destroy('Dischargerinfo', $id);
        // редирект
