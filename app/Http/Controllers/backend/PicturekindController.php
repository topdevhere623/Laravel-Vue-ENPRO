...
// модель
use App\Models\Picturekind;

// контроллер модели
class PicturekindController extends Controller
{
    ...
    public function index()
    {
        ...
        $content = Picturekind::paginate($paginate);

        // открыть вюшку
        return view('backend.picturekind.index', compact('content'));
    }
    ...
    public function edit($id = null)
    {
        // контент
        if ($id) {
            $content = Picturekind::findOrFail($id);
        } else {
            $content = new Picturekind;
        }
        ...
        // открыть вьюшку
        return view('backend.picturekind.edit', compact('content'));
    }

    // сохранение данных
    public function update($id = null, Request $request)
    {
        $bool = $this->commonCrudService->store('Picturekind', $id, $request);
        // редирект
        return redirect(route('picturekind.index'));
    }
    ...
    public function destroy($id)
    {
        ...
        $bool = $this->commonCrudService->destroy('Picturekind', $id);
        // редирект
