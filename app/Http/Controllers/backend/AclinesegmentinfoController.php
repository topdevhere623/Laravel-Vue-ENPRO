...
// контроллер модели
class AclinesegmentinfoController extends Controller
{
    ...
    public function index()
    {
        ...
        // $content = Aclinesegmentinfo::paginate($paginate);

        // открыть вюшку
        return view('backend.aclinesegmentinfo.index');
    }
     // список (Vue)
     public function vueIndex(Request $request)
     {
         ...
         $myReturn = Aclinesegmentinfo::when(isset($getFilterName), function ($query) use ($getFilterName) {
    ...
    public function edit($id = null)
    {
        // контент
        if ($id) {
            $content = Aclinesegmentinfo::findOrFail($id);
        } else {
            $content = new Aclinesegmentinfo;
        }
        ...
        // открыть вьюшку
        return view('backend.aclinesegmentinfo.edit', compact('content'));
    }

    // сохранение данных
    public function update($id = null, Request $request)
    {
        $bool = $this->commonCrudService->store('Aclinesegmentinfo', $id, $request);
        // редирект
        return redirect(route('aclinesegmentinfo.index'));
    }
    ...
    public function destroy($id)
    {
        ...
        $bool = $this->commonCrudService->destroy('Aclinesegmentinfo', $id);
        // редирект
