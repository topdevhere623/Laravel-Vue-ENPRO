...
class MaterialkindController extends Controller
{
    ...
    public function index()
    {
        ...
        // $content = Materialkind::paginate($paginate);

        // открыть вюшку
        return view('backend.materialkind.index');
    }
    public function vueIndex(Request $request)
    {
        ...
        $myReturn = Materialkind::when(isset($getFilterName), function ($query) use ($getFilterName) {
    ...
    public function edit($id = null)
    {
        // контент
        if ($id) {
            $content = Materialkind::findOrFail($id);
        } else {
            $content = new Materialkind;
        }
        ...
        // открыть вьюшку
        return view('backend.materialkind.edit', compact('content'));
    }

    // сохранение данных
    public function update($id = null, Request $request)
    {
        $bool = $this->commonCrudService->store('Materialkind', $id, $request);
        // редирект
        return redirect(route('materialkind.index'));
    }
    ...
    public function destroy($id)
    {
        ...
        $bool = $this->commonCrudService->destroy('Materialkind', $id);
        // редирект
