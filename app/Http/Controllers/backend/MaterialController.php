...
class MaterialController extends Controller
{
    ...
    public function index()
    {
        ...
        $content = Material::paginate($paginate);

        // открыть вюшку
        return view('backend.material.index', compact('content'));
    }
    ...
    public function edit($id = null)
    {
        // контент
        if ($id) {
            $content = Material::findOrFail($id);
        } else {
        ...
        // открыть вьюшку
        return view('backend.material.edit', compact('content'));
    }

    // сохранение данных
    public function update($id = null, Request $request)
    {
        $bool = $this->commonCrudService->store('Material', $id, $request);
        // редирект
    ...
    public function destroy($id)
    {
        ...
        $bool = $this->commonCrudService->destroy('Material', $id);
        // редирект
