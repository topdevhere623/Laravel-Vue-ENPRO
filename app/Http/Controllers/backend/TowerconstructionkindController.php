...
// контроллер модели
class TowerconstructionkindController extends Controller
{
    ...
    public function index()
    {
        ...
        // открыть вюшку
        return view('backend.towerconstructionkind.index');
    }
    ...
    public function vueIndex(Request $request)
    {
        ...
        $myReturn = Towerconstructionkind
    ...
    public function vueSave(Request $request)
    {
        ...
        if (isset($getSpravRowContent['id']) and $getSpravRowContent['id'] > 0) {
            $modelSave = Towerconstructionkind::find($getSpravRowContent['id']);
        } else {
            $modelSave = new Towerconstructionkind;
        }
        ...
        $modelSave = Towerconstructionkind::find($newID);
    ...
    public function destroy($getID)
    {
        ...
        $this->commonCrudService->destroy('Towerconstructionkind', $getID);
    }
    ...
    public function changeStatus($getID)
    {
        ...
        $model = Towerconstructionkind::find($getID);
        if ($model) {
