...
class CompanyController extends Controller
{
    ...
    public function index()
    {
        ...
        $content = Company::paginate($paginate);

        // открыть вюшку
        return view('backend.company.index', compact('content'));
    }
    ...
    public function edit($id = null)
    {
        ...
        // открыть вьюшку
        return view('backend.company.edit', compact('content'));
    }

    // сохранение данных
    public function update($id = null, Request $request)
    {
        $model = $this->commonCrudService->store('company', $id, $request, 'img');
    ...
    public function destroy($id)
    {
        ...
        $bool = $this->commonCrudService->destroy('company', $id);
        // редирект
