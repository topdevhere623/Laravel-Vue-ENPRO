...
class ClassnameController extends Controller
{
    ...
    public function index()
    {
        ...
        $content = Classname::paginate($paginate);

        // открыть вюшку
        return view('backend.classname.index', compact('content'));
    }
    ...
    public function edit($id = null)
    {
        // контент
        if ($id) {
            $content = Classname::findOrFail($id);
        } else {
        ...
        // открыть вьюшку
        return view('backend.classname.edit', compact('content'));
    }

    // сохранение данных
    public function update($id = null, Request $request)
    {
        $bool = $this->commonCrudService->store('Classname', $id, $request);
        // редирект
    ...
    public function destroy($id)
    {
        ...
        $bool = $this->commonCrudService->destroy('Classname', $id);
        // редирект
