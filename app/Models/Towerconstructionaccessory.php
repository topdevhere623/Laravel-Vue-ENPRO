...
// модель
class Towerconstructionaccessory extends Model
{
    // подключение трайтов
    use CommonTrait;
    ...
    // управляемая таблица
    protected $table = "towerconstructionaccessory";
    ...
    // мои атрибуты модели
    const title1 = "Компонент - арматура линейная";
    const title2 = "Компоненты - арматура линейная";

    // возвращает папку хранения изображения
    public function folderPath()
    {
        return 'uploads/models/towerconstructionaccessory/' . $this->id;
    }
