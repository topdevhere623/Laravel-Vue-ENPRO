 ...
 */
class ResistancePerLength extends BaseModel
{
    ...
    // управляемая таблица
    public $table = 'resistance_per_length';
    ...
    protected static function boot()
    {
        ...
        static::creating(function (ResistancePerLength $model) {
    ...
    public function getResistancePerLength() : ResistancePerLength
    {
        return $this;
    }
}
